    ...
    <el-card class="head-card">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        <el-form-item label="学科编号">
          <el-input style="width:100px" v-model="formInline.rid"></el-input>
        </el-form-item>
        <el-form-item label="学科名称">
          <el-input v-model="formInline.name" style="width:130px"></el-input>
        </el-form-item>
        <el-form-item label="创建者">
          <el-input style="width:100px" v-model="formInline.username"></el-input>
        </el-form-item>
        <el-form-item  label="状态">
          <el-select style="width:130px" v-model="formInline.status" placeholder="请选择状态">
